...
<section class="bg-bg py-20 md:px-20 px-5 lg:py-[120px] overflow-hidden relative z-10">
	<div class="container">
		<div class="flex flex-wrap lg:justify-between -mx-4">
			<div class="w-full lg:w-1/2 xl:w-6/12 px-4">
				<div class="max-w-[570px] mb-12 lg:mb-0">
					<!-- <span class="block mb-4 text-base text-primary font-semibold"> Contact Us </span> -->
					<h2
						class="
                  text-dark
                  mb-6
					...
					<div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
						...
						<div class="w-full space-y-2">
							<!-- <h4 class="font-bold text-dark text-xl mb-1"></h4> -->
							<a
								href="https://www.instagram.com/stemlab_ng/"
								class="text-base text-body-color block"
								><i class="fab fa-instagram fa-xl mr-2" /> Stemlab_ng</a
							>
							<a href="https://wa.link/xalr68" class="text-base text-body-color block"
								><i class="fab fa-whatsapp fa-xl mr-2" /> +2347014085472</a
							>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
						...
						<div class="w-full">
							...
							<a href="tel:+2348162224407">
								<p class="text-base text-body-color">+234 816 222 4407</p></a
							>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
						...
						<div class="w-full">
							...
							<a href="mailto:admin@stemlab.com.ng">
								<p class="text-base text-body-color">STEMLab</p></a
							>
						</div>
					</div>
				</div>
